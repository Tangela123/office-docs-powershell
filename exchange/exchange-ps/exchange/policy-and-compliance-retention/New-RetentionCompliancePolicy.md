...
## DESCRIPTION
New policies are not valid and will not be applied until a retention rule is added to the policy. In addtion, at list one location parameter must be defined to create a Retention Policy.
